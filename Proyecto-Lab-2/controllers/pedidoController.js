...
const crearPedido = async (req, res) => {
  const{ id, diagnostico, nombre_medico, nro_matricula,fechacreacion,fechaEntrega,valorPrioridad,estado_final,analisisMuestras }= req.body;
  ...
  try {
    const pedido = await Pedido.create({
      ...
      ordenController.crearOrdenPrincipal(registro.id_pedido,true,fechacreacion,fechaEntrega,valorPrioridad,estado_final,analisisMuestras)
    }).then(()=>{
