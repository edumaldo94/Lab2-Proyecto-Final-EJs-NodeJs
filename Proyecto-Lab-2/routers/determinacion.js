...
router.get('/paraValidar/:id_examen/:genero/:id_orden/:rol',authMiddleware.requireAuth, determinacionController.obtenerResultadoExamen);
router.get('/cargarValor/:id_orden',authMiddleware.requireAuth, determinacionController.obtenerDeter);

router.get('/resultados-examenes/:id_examenesArray/:genero/:id_orden/:rol',authMiddleware.requireAuth,determinacionController.obtenerMasDeUnResultadoExamen);
