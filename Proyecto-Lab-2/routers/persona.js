...
router.get('/nueva/:rol', authMiddleware.requireAuth, (req, res) => {
    ...
    res.render('createPaciente',{rol: rol,nombre, apellido});
});
...
router.get('/pacien_te/orden_final',authMiddleware.requireAuth,personaController.renderDniPaciente);
router.get('/porEmail/userEmail/:email/:rol',authMiddleware.requireAuth,personaController.renderEmail);
