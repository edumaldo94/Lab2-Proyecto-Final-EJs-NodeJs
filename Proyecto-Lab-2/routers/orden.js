...
router.get('/orden-id/:id/:rol',authMiddleware.requireAuth, ordenController.listarPorID)
...
router.post('/ordenExa/crearOrden',authMiddleware.requireAuth, async (req, res) => {
  ...
  const ordenCreada = await ordenController.crearOrden(idPedido, null, null,null,null,estadoOrden,null,analisisMuestras);
...
router.put('/ordenFinal/estado_final/:idOrden',ordenController.cambioAestadoFinal);
