...
const nombreRol= document.getElementById('nombreInput').value;
const apellidoRol= document.getElementById('apellidoInput').value;
...
document.getElementById('guardarValor').addEventListener('click', async () => {
    ...
    if (respon.ok) {
        window.location.href=`/page-Tecnico?nombre=${nombreRol}&apellido=${apellidoRol}`
